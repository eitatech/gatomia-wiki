...
from gatowiki.cli.utils.errors import RepositoryError
from gatowiki.cli.utils.validation import validate_repository_path, detect_supported_languages
...
def validate_repository(repo_path: Path) -> Tuple[Path, List[Tuple[str, int]]]:
    ...
    if not languages:
        raise RepositoryError(
            ...
            "GatoWiki supports: Python, Java, JavaScript, TypeScript, C, C++, C#\n\n"
