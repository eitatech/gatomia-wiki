    ...
    def handle_api_error(
        ...
        if "429" in error_message or "rate limit" in error_message.lower():
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Verify your API key: gatowiki config show\n"
                "  2. Update your API key: gatowiki config set --api-key <new-key>\n"
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Check your internet connection\n"
                "  2. Verify the base URL: gatowiki config show\n"
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Check your configuration: gatowiki config validate\n"
